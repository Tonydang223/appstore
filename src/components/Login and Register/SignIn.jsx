...
const SignIn = () => {
  ...
  const submitLogin = async (form) => {
    const getUsers = await api
      .get("/users")
      .then((res) => checkAccount(res.data, form));
    if (getUsers) {
        ...
        <Formik
          ...
          validate={(values) => {
            ...
            if (!values.password.trim()) {
              ...
              errors.password =
                "Password needs to be at least 6 characters and more";
            }
            return errors;
          }}
          onSubmit={(values) => {
          ...
          {({
            ...
            <Form onSubmit={handleSubmit} className={classes.form}>
              <Grid container spacing={2}>
                <Grid item xs={12}>
                  <TextFields
                    ...
                    type="email"
                    placeholder="Email"
                    className="inputBox inputBoxBottom"
                  ></TextFields>
                </Grid>
                <Grid item xs={12}>
                  <TextFields
              ...
              <Grid container justify="flex-end">
                <Grid item>
                  <Link to="/signUp" variant="body2" href>
